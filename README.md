...
いずれも **m=32 / D=167 / AI RAM ~11KB**＝実機（SRAM 16KB / Flash 256KB）に収まる。移植元 IchiPing CNN も現地校正で 32cls 最大 100% を達成しており、本移植版は**同等クラスの精度を、学習パラメータ約 1/51・16KB MCU・オンデバイス学習で実現**する点に価値がある。
